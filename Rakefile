...
namespace :db do
  def create_database config
    ...
    create_db = lambda do |c|
      ActiveRecord::Base.establish_connection c.merge('database' => nil)
      ActiveRecord::Base.connection.create_database c['database'], options
  ...
  task :configuration => :environment do
    @config = KAG::Config.instance[:database][DATABASE_ENV]
  end
